import { BLAKE2, BlakeOpts } from '@noble/hashes/_blake2.js';
...
export declare const blake2s: {
    (msg: import("@noble/hashes/utils.js").Input, opts?: BlakeOpts | undefined): Uint8Array;
    outputLen: number;
    blockLen: number;
    create(opts: BlakeOpts): import("@noble/hashes/utils.js").Hash<BLAKE2s>;
};
export {};
