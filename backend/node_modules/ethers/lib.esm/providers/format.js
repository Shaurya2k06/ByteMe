 ...
 *  @_ignore
 */
import { getAddress, getCreateAddress } from "ethers/lib.commonjs/address/index.js";
import { Signature } from "ethers/lib.commonjs/crypto/index.js";
import { accessListify } from "ethers/lib.commonjs/transaction/index.js";
import { getBigInt, getNumber, hexlify, isHexString, zeroPadValue, assert, assertArgument } from "ethers/lib.commonjs/utils/index.js";
const BN_0 = BigInt(0);
